...
exports.UserOperationEventListener = exports.DEFAULT_TRANSACTION_TIMEOUT = void 0;
const utils_1 = require("ethers/lib/utils");
const debug_1 = __importDefault(require("debug"));
const debug = (0, debug_1.default)('aa.listener');
exports.DEFAULT_TRANSACTION_TIMEOUT = 60000;
/**
...
class UserOperationEventListener {
    constructor(resolve, reject, entryPoint, sender, userOpHash, nonce, timeout) {
        ...
        }, (_a = this.timeout) !== null && _a !== void 0 ? _a : exports.DEFAULT_TRANSACTION_TIMEOUT);
    }
    start() {
        // eslint-disable-next-line @typescript-eslint/no-misused-promises

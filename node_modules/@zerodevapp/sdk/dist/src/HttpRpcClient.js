...
class HttpRpcClient {
    constructor(bundlerUrl, entryPointAddress, chainId, projectId, skipFetchSetup, bundlerProvider) {
        this.bundlerUrl = bundlerUrl;
        this.entryPointAddress = entryPointAddress;
        this.chainId = chainId;
        this.projectId = projectId;
        this.skipFetchSetup = skipFetchSetup;
        this.bundlerProvider = bundlerProvider;
        this.userOpJsonRpcProvider = new ethers_1.ethers.providers.JsonRpcProvider({
            url: this.bundlerUrl,
            headers: Object.assign({ projectId }, (bundlerProvider !== undefined ? { bundlerProvider } : {})),
            skipFetchSetup: skipFetchSetup !== null && skipFetchSetup !== void 0 ? skipFetchSetup : undefined
        }, {

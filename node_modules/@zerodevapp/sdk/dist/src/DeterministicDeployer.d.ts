...
export declare class DeterministicDeployer {
    ...
    static getAddress(ctrCode: string): Promise<string>;
    static getAddress(ctrCode: ContractFactory, salt: BigNumberish, params: any[]): Promise<string>;
    /**
    ...
    getDeterministicDeployAddress(ctrCode: string | ContractFactory, salt?: BigNumberish, params?: any[]): Promise<string>;

...
export interface EIP4337ManagerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "eip4337Fallback" | "entryPoint" | "executeAndRevert" | "getCurrentEIP4337Manager" | "replaceEIP4337Manager" | "setup4337Modules" | "validateEip4337" | "validateUserOp"): FunctionFragment;

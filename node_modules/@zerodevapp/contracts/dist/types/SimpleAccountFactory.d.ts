...
export interface SimpleAccountFactory extends BaseContract {
    ...
    filters: {
        "AccountCreated(address,address,uint256)"(account?: PromiseOrValue<string> | null, owner?: PromiseOrValue<string> | null, salt?: null): AccountCreatedEventFilter;
        AccountCreated(account?: PromiseOrValue<string> | null, owner?: PromiseOrValue<string> | null, salt?: null): AccountCreatedEventFilter;
    };
    estimateGas: {

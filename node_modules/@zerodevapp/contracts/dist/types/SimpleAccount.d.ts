...
export interface SimpleAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addDeposit" | "entryPoint" | "execute" | "executeBatch" | "getDeposit" | "initialize" | "isValidSignature" | "nonce" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "owner" | "proxiableUUID" | "supportsInterface" | "tokensReceived" | "upgradeTo" | "upgradeToAndCall" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;

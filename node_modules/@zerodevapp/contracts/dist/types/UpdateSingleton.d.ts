...
export interface UpdateSingletonInterface extends utils.Interface {
    functions: {
        "self()": FunctionFragment;
        "update(address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "self" | "update"): FunctionFragment;
...
export interface UpdateSingleton extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: UpdateSingletonInterface;
    ...
    functions: {
        ...
        update(targetSingleton: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        self(overrides?: CallOverrides): Promise<string>;
        update(targetSingleton: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {

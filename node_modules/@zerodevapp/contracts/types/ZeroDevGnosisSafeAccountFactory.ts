...
export interface ZeroDevGnosisSafeAccountFactoryInterface
  extends utils.Interface {
  functions: {
    "createAccount(address,uint256)": FunctionFragment;
    "defaultCallback()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "defaultCallback",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ZeroDevGnosisSafeAccountFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZeroDevGnosisSafeAccountFactoryInterface;
  ...
  functions: {
    ...
    defaultCallback(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    defaultCallback(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    defaultCallback(overrides?: CallOverrides): Promise<PopulatedTransaction>;

...
export interface SessionKeyOwnedValidatorInterface extends utils.Interface {
  functions: {
...
export interface SessionKeyOwnedValidator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SessionKeyOwnedValidatorInterface;

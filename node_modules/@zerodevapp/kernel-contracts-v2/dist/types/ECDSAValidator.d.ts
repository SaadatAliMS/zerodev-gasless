...
export interface ECDSAValidatorInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "ecdsaValidatorStorage", values: [PromiseOrValue<string>]): string;
...
export interface ECDSAValidator extends BaseContract {
    ...
    functions: {
        disable(arg0: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ecdsaValidatorStorage(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string] & {
            owner: string;
        }>;
    ...
    validateUserOp(_userOp: UserOperationStruct, _userOpHash: PromiseOrValue<BytesLike>, arg2: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    callStatic: {
        disable(arg0: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        ecdsaValidatorStorage(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        "OwnerChanged(address,address,address)"(kernel?: PromiseOrValue<string> | null, oldOwner?: PromiseOrValue<string> | null, newOwner?: PromiseOrValue<string> | null): OwnerChangedEventFilter;
        OwnerChanged(kernel?: PromiseOrValue<string> | null, oldOwner?: PromiseOrValue<string> | null, newOwner?: PromiseOrValue<string> | null): OwnerChangedEventFilter;
    };
    estimateGas: {
        disable(arg0: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        ecdsaValidatorStorage(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        enable(_data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        validateSignature(hash: PromiseOrValue<BytesLike>, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        ecdsaValidatorStorage(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        enable(_data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;

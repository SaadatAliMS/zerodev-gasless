...
export interface KernelFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getAccountAddress", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>
    ]): string;
...
export interface KernelFactory extends BaseContract {
    ...
    functions: {
        createAccount(_validator: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, _index: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        entryPoint(overrides?: CallOverrides): Promise<[string]>;
        getAccountAddress(_validator: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
    ...
    nextTemplate(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        createAccount(_validator: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        entryPoint(overrides?: CallOverrides): Promise<string>;
        getAccountAddress(_validator: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        kernelTemplate(overrides?: CallOverrides): Promise<string>;
        nextTemplate(overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        "AccountCreated(address,address,bytes,uint256)"(account?: PromiseOrValue<string> | null, validator?: PromiseOrValue<string> | null, data?: null, index?: null): AccountCreatedEventFilter;
        AccountCreated(account?: PromiseOrValue<string> | null, validator?: PromiseOrValue<string> | null, data?: null, index?: null): AccountCreatedEventFilter;
    };
    estimateGas: {
        createAccount(_validator: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, _index: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        ...
        getAccountAddress(_validator: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getAccountAddress(_validator: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;

...
export interface Kernel extends BaseContract {
    ...
    functions: {
        ...
        execute(to: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, operation: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        entryPoint(overrides?: CallOverrides): Promise<string>;
        execute(to: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, operation: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        getDefaultValidator(overrides?: CallOverrides): Promise<string>;
        getDisabledMode(overrides?: CallOverrides): Promise<string>;
        getExecution(_selector: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<ExecutionDetailStructOutput>;
        getLastDisabledTime(overrides?: CallOverrides): Promise<number>;

...
export interface KernelInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "entryPoint" | "executeAndRevert" | "getNonce(uint192)" | "getNonce()" | "getOwner" | "initialize" | "isValidSignature" | "name" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "queryPlugin" | "transferOwnership" | "upgradeTo" | "validateUserOp" | "version"): FunctionFragment;

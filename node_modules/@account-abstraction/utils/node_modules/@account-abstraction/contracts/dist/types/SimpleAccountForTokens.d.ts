...
export interface SimpleAccountForTokensInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addDeposit" | "entryPoint" | "execute" | "executeBatch" | "getDeposit" | "initialize(address,address,address)" | "initialize(address)" | "nonce" | "owner" | "proxiableUUID" | "upgradeTo" | "upgradeToAndCall" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "initialize(address,address,address)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>
    ]): string;
...
export interface SimpleAccountForTokens extends BaseContract {
    ...
    functions: {
        ...
        "initialize(address,address,address)"(_owner: PromiseOrValue<string>, token: PromiseOrValue<string>, paymaster: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getDeposit(overrides?: CallOverrides): Promise<BigNumber>;
        "initialize(address,address,address)"(_owner: PromiseOrValue<string>, token: PromiseOrValue<string>, paymaster: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
